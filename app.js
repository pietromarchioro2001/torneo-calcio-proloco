...
function openRigoriPopup(directMode = false) {
    ...
    if (directMode) {
        ...
        // Uso i dati dalla cache immediatamente
        const rigoriState = {
            fase: 'tiri',
...
// 🔥 FIX: Se non c'è localStorage ma la partita è in RIGORI, recupera dal backend
...
// Se abbiamo lo stato da localStorage, usalo
